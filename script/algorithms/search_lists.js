...
function closeSortBtn(sortBtnIds, keywords, data, sortedData, nameOfList, colorOfList, nameOfListElementID) {
    sortBtnIds.forEach((member) => {
        document.getElementById(member).addEventListener('click', () => {
            ...
            let returnKeywordTab = keywords.filter((e) => {

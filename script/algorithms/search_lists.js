...
function updateTAG(tagTab, keywords) {
    for(let k=0; k<keywords.length; k++) {
        ...
        for(let n=0; n<tagTab.length; n++) {
            if(keyword === tagTab[n]) {
                let indexElement = tagTab.indexOf(tagTab[n])
                // puis on le supprime du tableau
